...
%INPUT: ints n,m
%
%OUTPUT: Cell of arrays rank and cell of matrices Chains of equal length
%
%DESCRIPTION: Chains is the chain complex in the bottom level for the (n,m) sphere, with Chains{i} being the i-1 differential. rank collects the ranks

...
%Inputs: int i and arrays rankC,rankD
%Outputs: Arrays rank and detailedrank
%Description: Compute the rank of the box product of chain complexes given their ranks. 
%detailedrank stores the rank of each summand in the box product separately
%It's only used when multiplying generators (see C4mult).
